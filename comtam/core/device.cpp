...
void Device::submit_bop(const Command& command, KernelLibrary& kernels) {
    ...
    COMTAM_LOG_DEBUG(
        "submit dispatch:\nN={}\nthread_width={}\nthreads=({}, {}, {})\n"
        "threads_per_group=({}, {}, {})\n",
        command.a.view.N, w, threads.width, threads.height, threads.depth, threads_per_group.width,
...
void Device::submit_matmul(const Command& command, KernelLibrary& kernels) {
    ...
    COMTAM_LOG_DEBUG(
        "submit dispatch:\nN={}\nthread_width={}\nthreads=({}, {}, {})\n"
        "threads_per_group=({}, {}, {})\n",
        command.a.view.N, w, grid_size.width, grid_size.height, grid_size.depth, group_size.width,
